...
export const Head = () => {
  ...
  return (
    <Box width="100%" height="calc(100vh - 8px)" sx={{ position: "relative" }}>
      ...
      />
      <Flex justifyContent="center" pt={5} width="100%">
        <Flex flexDirection="column" alignItems="center" width="100%">
          ...
          <Text as="h2" color="#e7e6d6" fontWeight={900} fontSize={6} mt={3}>
            Débute bientôt
          </Text>
          <Flex
            color="#e7e6d6"
      ...
      <Flex px={6} sx={{ position: "absolute", bottom: 120 }}>
        <Flex flex={1}>
          <Text as="h1" display="flex" alignItems="center" fontSize="108px" color="#e7e6d6" textAlign="center">
            Gala
          </Text>
        </Flex>
        <Flex flex={1}>
          <Text as="p" display="flex" alignItems="center" fontSize="24px" color="#e7e6d6" fontWeight={700} mr="10%">
